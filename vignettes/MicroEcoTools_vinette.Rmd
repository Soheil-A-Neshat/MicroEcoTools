...
summary.CSR_assignments(csr_result$CSR_assignments)
```
...
summary.CSR_simulation(simulation_result)
```
...
summary.Welch_ANOVA(result_welch)
```
...
summary.Pairwise_welch(pairwise_result)
```
